...
export const courses: Course[] = [
  {
    ...
    tagline: "One-to-One Online Session for emotional healing & inner alignment",
    description:
      "A personalised session designed to support emotional healing, mental clarity, inner transformation, energy balancing and overall well-being. Every session is customised according to your personal challenges, emotional state, lifestyle and healing requirements.",
    coverImage:
  ...
  {
    id: "c3",
    title: "Garbha Sanskar — Conscious Pregnancy Session",
    slug: "garbha-sanskar",
  ...
  },
  {
    ...
    tagline: "A one-month healing & growth journey — 8 online sessions",
    description:
    ...
    price: 9999,
    originalPrice: null,
    duration: "1 Month · 8 Online Sessions",
    level: "All levels",
    modules: JSON.stringify([
      ...
      { title: "Group Program Option", lessons: ["Same structure", "Group container", "Energy Exchange: ₹5555"] },
    ]),
    outcomes: JSON.stringify([
